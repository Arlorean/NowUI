...
try {
    & $Python (Join-Path $PSScriptRoot 'NowUI-EncodeWebp.py') --frames $nativeFrames --pattern $nativeRecording.pattern --count $nativeRecording.frames --fps $nativeRecording.fps --quality $Quality --method $Method --output $nativeTemporary
